...
<div class="container" style="padding: 0px" >
  ...
  <div class="row" style="margin-bottom: 100px">
     ...
     <form  method="post" action="{{url('admin/locations/update/' . $getid->id)}}" >
      {{ csrf_field() }}
        <div class="col-md-6" >
              <div class="form-group">
                <label for="formGroupExampleInput">Address</label>
                <input type="text" class="form-control"   name="address" value="{{$getid->address}}">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control"  name="categoryid" value="{{$getid->category_id}}">
              </div>
              <div class="form-group">
                <label for="formGroupExampleInput2">City ID</label>
                <input type="text" class="form-control" name="cityid" value="{{$getid->city_id}}">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="description" value="{{$descr}}">
              </div>
              <button class="btn btn-primary" type="submit" name="save">Change</button>
              <a href="admin"><button class="btn btn-dark" type="nosave" name="save">No change</button></a>
        </div>
