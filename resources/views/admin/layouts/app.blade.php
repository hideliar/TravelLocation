...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="admin" class="logo">
      ...
      <span class="logo-lg"><b>Travel</b>Location</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">MAIN NAVIGATION</li>
          ...
          <a href="admin/location">
            ...
            <li>
          <a href="admin/city">
            <i class="fa fa-university"></i> <span>City</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-red"></small>
              <small class="label pull-right bg-blue"></small>
            </span>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="admin/slide"><i class="fa fa-bullhorn"></i>Slide advertisement</a></li>
        ...
        <li><a href="../TravelLocation/template"><i class="fa fa-circle-o text-aqua"></i> <span>Index TravelLocation</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
