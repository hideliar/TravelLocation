...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/slideourteam.css">
  ...
  <body>
    ...
    <div id="menu-top" class="row" style="top:0px">
      <nav class="navbar navbar-expand-sm fixed-top navbar-dark">
          <a class="navbar-brand logo-main" href="#"><img src="img/logo.png"></a>
          ...
          <div class="collapse navbar-collapse" id="collapsibleNavId">
              ...
              <div class="dropdown text-center">
                    ...
                    <!-- @if (Auth::guest())    
                      <a href="../login"><button class="btn btn-secondary dropdown-toggle" type="button">Login</button></a>
                      <a href="../register"><button class="btn btn-secondary dropdown-toggle" type="button">Register</button></a>
                    @else
                     <a href="../profi"><button class="btn btn-secondary dropdown-toggle" type="button">{{ Auth::user()->name }}</button></a>
                    @endif -->
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              <div class="search-back rounded">
                  ...
                  <div class="search-form">
                    <form action="/TravelLocation/template/search.php" method="GET">
...
<!--        <div class="row w-100" id="map-box">
            ...
            <div class="news">
                <div class="card-deck">
                  <div class="col-lg-3 col-md-6">
                    <div class="card m-0">
                      <img class="card-img-top" src="img/dest.373x181.01.png" alt="Card image cap">
                      <div class="card-body">
                  ...
                  <div class="col-lg-3 col-md-6">
                    <div class="card m-0">
                      <img class="card-img-top" src="img/dest.181x181.01.png" alt="Card image cap">
                      <div class="card-body">
                    ...
                    <div class="col-lg-3 col-md-6">
                    <div class="card m-0">
                      <img class="card-img-top" src="img/dest.373x181.02.png" alt="Card image cap">
                      <div class="card-body">
                  ...
                  <div class="col-lg-3 col-md-6">
                    <div class="card m-0">
                      <img class="card-img-top" style="height: 130px;" src="img/phuquoc.jpg" alt="Card image cap">
                      <div class="card-body">
        ...
        <ul class="row">
          <li class="col-12 col-md-6 col-lg-3">
              <div class="cnt-block equal-hight" style="height: 349px;">
                <figure><img src="img/vantruc.jpg" class="img-responsive" alt=""></figure>
          ...
          <li class="col-12 col-md-6 col-lg-3">
              <div class="cnt-block equal-hight" style="height: 349px;">
                <figure><img src="img/quy.jpg" class="img-responsive" alt=""></figure>
          ...
          <li class="col-12 col-md-6 col-lg-3">
              <div class="cnt-block equal-hight" style="height: 349px;">
                <figure><img src="img/ngoctoan.jpg" class="img-responsive" alt=""></figure>
  ...
  <footer class="p-5 bg-theme text-small footer">
          ...
          <div class="row">
              <div class="col-12 col-sm-12 col-md-3 text-white">
                <a class="footer-logo" href="#">
                  <img src="img/logo.png" class=" mb-5" alt=""></a>
    ...
    <script src="js/select-location.js"></script>
